...
<Info>
  This is a temporary clone of the official https://agentskills.io/ site while that site is inaccessible.
</Info>
...
<img
  ...
  style={{ width:"150px",maxWidth:"100%" }}
  src="/images/logos/opencode/opencode-wordmark-dark.svg"
  alt="OpenCode"
  noZoom={true}
/>
...
<img
  className="hidden dark:block object-contain"
  style={{ width:"150px",maxWidth:"100%" }}
  src="/images/logos/cursor/LOCKUP_HORIZONTAL_2D_DARK.svg"
  alt="Cursor"
  noZoom={true}
/>
...
<img
  className="hidden dark:block object-contain"
  style={{ width:"120px",maxWidth:"100%" }}
  src="/images/logos/amp/amp-logo-dark.svg"
  alt="Amp"
  noZoom={true}
/>
...
<img
  className="hidden dark:block object-contain"
  style={{ width:"150px",maxWidth:"100%" }}
  src="/images/logos/letta/Letta-logo-RGB_GreyonTransparent.svg"
  alt="Letta"
  noZoom={true}
/>
...
<img
  className="hidden dark:block object-contain"
  style={{ width:"150px",maxWidth:"100%" }}
  src="/images/logos/goose/goose-logo-white.png"
  alt="Goose"
  noZoom={true}
/>
...
<img
  className="hidden dark:block object-contain"
  style={{ width:"150px",maxWidth:"100%" }}
  src="/images/logos/github/GitHub_Lockup_Light.svg"
  alt="GitHub"
  noZoom={true}
/>
...
<img
  className="hidden dark:block object-contain"
  style={{ width:"150px",maxWidth:"100%" }}
  src="/images/logos/vscode/vscode-alt.svg"
  alt="VS Code"
  noZoom={true}
/>
...
<img
  className="hidden dark:block object-contain"
  style={{ width:"150px",maxWidth:"100%" }}
  src="/images/logos/claude-code/Claude-Code-logo-Ivory.svg"
  alt="Claude Code"
  noZoom={true}
/>
...
<img
  className="hidden dark:block object-contain"
  style={{ width:"150px",maxWidth:"100%" }}
  src="/images/logos/claude-ai/Claude-logo-Ivory.svg"
  alt="Claude"
  noZoom={true}
/>
...
<img
  className="hidden dark:block object-contain"
  style={{ width:"150px",maxWidth:"100%" }}
  src="/images/logos/oai-codex/OAI_Codex-Lockup_400px_Darkmode.svg"
  alt="OpenAI Codex"
  noZoom={true}
/>
